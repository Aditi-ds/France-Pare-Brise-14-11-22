...
export const liveAPIKey = "07bc573238acb4f13a408f3aa4a84ccc";

export const googleMapsApiKey = "AIzaSyDZNQlSlEIkFAct5VzUtsP4dSbvOr2bE18";

export const savedFilterId = "1097497922";
...
export const AnswerExperienceConfig =  {
    experienceKey: "france-pare-brise",
    locale:"fr",
    apiKey: "010940be713a685785ce7ecf2f5e5be8",
    verticalKey: "locations",
    experienceVersion: "STAGING",
    sessionTrackingEnabled: true,
    endpoints:{
        universalSearch: "https://liveapi-sandbox.yext.com/v2/accounts/me/answers/query",
        verticalSearch: "https://liveapi-sandbox.yext.com/v2/accounts/me/answers/vertical/query?locationRadius=1600000",
