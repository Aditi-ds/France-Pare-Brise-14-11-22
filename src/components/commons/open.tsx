      ...
      if (props.isToday == true) {
        status = (
          <>
            ...
            - <span>Ouvre à {props.day?.openIntervals[0].start} </span>
          </>
        );
      }
    } else if (
      ...
      if (props.isToday == true) {
        status = (
          <>
            ...
            - <span>Ferme à {props.day?.openIntervals[0].end} </span>
          </>
        );
      }
    } else {
      if (props.isToday == true) {
        status = (
          <>
            ...
            - <span>Fermé à {props.day?.openIntervals[1].end} </span>
          </>
        );
      }
    }
    ...
    if (props.isToday == true) {
      status = openDays.length ? (
        <>
          ...
          -{" "}
          <span>
          Ouvre le {openDays[0].key} at {openDays[0].openIntervals[0].start}
          </span>
        </>
      ) : (
        <>
